...
If you look at the [list of grype-db issues](https://github.com/anchore/grype-db/issues) there are plenty of bugs and feature requests.

## Commit guidelines

In the grype-db project we like commits and pull requests (PR) to be easy to understand and review. Open source thrives best when everything happening is over documented and small enough to be understood.
