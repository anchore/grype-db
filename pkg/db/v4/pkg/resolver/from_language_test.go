...
import (
	...
	"github.com/anchore/grype-db/pkg/db/v4/pkg/resolver/java"
	"github.com/anchore/grype-db/pkg/db/v4/pkg/resolver/python"
	"github.com/anchore/grype-db/pkg/db/v4/pkg/resolver/stock"
