...
require (
	...
	github.com/anchore/grype v0.92.3-0.20250602193552-744295c465ab
...
replace github.com/anchore/grype => github.com/orizerah/grype v0.0.0-20250508131820-df8bcc796bd0
